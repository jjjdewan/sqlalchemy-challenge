#######################################################
# This python script uses flask and SQL alchemy to enable the API
# requests on weather data of Honolulu, HI that must be
# suitbale for surfing during some time of the year
# Yes, I am planning for a vaction to the area.
# Off-course, the data analysis will help me
#
#########################################################
...
# Function: `calc_temps` - it will accept start date and end date in the format '%Y-%m-%d'
...
def precipitation():
    ...
    begin_date = max_date - datetime.timedelta(365)
